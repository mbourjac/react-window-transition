      ...
      <div className="flex flex-col justify-between border-r border-black bg-white p-4">
        <div className="flex flex-col gap-4">
          ...
          <p className="w-1/2 indent-12 text-2xl tracking-wider">
            Laboriosam alias nulla delectus atque at exercitationem eligendi est
            nobis, debitis ipsam in, error optio.
          </p>
        </div>
        <p className="text-end text-2xl tracking-wider">— alias voluptatibus</p>
      </div>
